...
ActiveRecord::Schema.define(version: 2019_02_05_204813) do
  ...
  create_table "preparations", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["coffee_id"], name: "index_preparations_on_coffee_id"
    t.index ["technique_id"], name: "index_preparations_on_technique_id"
  ...
  create_table "usercoffees", force: :cascade do |t|
    t.bigint "user_id", null: false
    t.bigint "coffee_id", null: false
    t.index ["coffee_id"], name: "index_usercoffees_on_coffee_id"
    t.index ["user_id"], name: "index_usercoffees_on_user_id"
  end
